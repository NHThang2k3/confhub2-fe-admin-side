...
interface Config {
  ...
  NEXT_PUBLIC_RECOMMENDATION_SYSTEM_URL: string;
}
export const appConfig: Config = {
  NEXT_PUBLIC_DATABASE_URL: process.env.NEXT_PUBLIC_DATABASE_URL || 'https://confhub.westus3.cloudapp.azure.com', // Provide a default value
  ...
  NEXT_PUBLIC_RECOMMENDATION_SYSTEM_URL: process.env.NEXT_PUBLIC_RECOMMENDATION_SYSTEM_URL || 'http://localhost:8000',
